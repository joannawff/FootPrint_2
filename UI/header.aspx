<%@ Page Language="C#" AutoEventWireup="true" CodeFile="header.aspx.cs" Inherits="UI_header" %>
...
<div id="all">
    ...
    <div id="nav">
    	<ul>
        	<li class="inactive" id="other"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="about"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="user"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="news"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="mars"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="jielong"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="box"><a href="menu.aspx" target="menu">管理操作</a></li>
            <li class="inactive" id="school"><a href="menu.aspx" target="menu">修改密码</a></li>
            <li class="active" id="config"><a href="menu.aspx" target="menu">项目注册</a></li>
        </ul>
    </div>
    <div id="main">
    	<div id="welcome">欢迎你回来,Admin! <img src="images/clock.gif" /> 现在时间: 2017年11月24日01点44分 星期五 </div>
        <div id="adminop">
            <ul>
                <li><a href="#">站点首页</a></li>
                <li><a href="javascript:parent.location.reload();">管理首页</a></li>
                <li><a href="JavaScript:parent.window.location.href= '../Login.aspx ';">退出管理</a></li>
                <li><a href="#">站点首页</a></li>
            </ul>
        </div>
    </div>
